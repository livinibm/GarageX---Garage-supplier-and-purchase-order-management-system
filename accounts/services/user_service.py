...
def get_user_profile(user):
    ...
    if user.profile.role == 'GARAGE':
        profile_data['garage_info'] = get_garage_details(user)
...
def get_garage_details(user):
    """Get garage-specific details for user"""
    # This would typically fetch garage-specific information
    return {
        'department': 'Garage Operations',
        'access_level': 'Full Garage Access'
    }
